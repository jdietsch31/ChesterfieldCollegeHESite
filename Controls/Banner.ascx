...
<asp:Panel ID="VerticalPanel" runat="server">
  <a href="/HeDepartments/Default.aspx" target="_blank" runat="server" id="VerticalLink">
...
<asp:Panel ID="HorizontalPanel" runat="server">
  <a href="/HelpAdvice/Default.aspx" target="_blank" runat="server" id="HorizontalLink">
